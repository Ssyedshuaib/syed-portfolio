    ...
    >
      ...
      >
        <Link href="/" className="flex items-center gap-4 group cursor-pointer">
          ...
          />
          <span className="text-[#FFFFFF] font-headline font-bold text-[10px] tracking-[0.5em] uppercase group-hover:text-[#EAE0C8] transition-colors">
            SYED
          </span>
        </Link>
        ...
        <div className="hidden lg:flex items-center gap-8 text-[9px] font-bold tracking-[0.4em] text-[#EAE0C8]/70 uppercase">
          {NAV_LINKS.map((link) => (
            <motion.div key={link.label} whileHover={{ y: -2 }}>
              ...
              >
                {link.label}
                <span className="absolute -bottom-1.5 left-0 w-0 h-px bg-[#536878] transition-all duration-700 group-hover:w-full" />
              </Link>
            </motion.div>
          ))}
        </div>
        ...
        >
          <Link 
            href="#contact"
            className="bg-[#EAE0C8] text-[#0F1317] px-8 py-2.5 rounded-full text-[9px] font-bold tracking-[0.4em] uppercase hover:bg-[#FFFFFF] transition-all shadow-[0_10px_30px_rgba(234,224,200,0.15)]"
          >
            Contact
          </Link>
        </motion.div>
