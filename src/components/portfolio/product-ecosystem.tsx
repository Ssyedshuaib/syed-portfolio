...
export function ProductEcosystem() {
  return (
    <section id="ecosystem" className="py-48 px-6 bg-black">
      <div className="max-w-7xl mx-auto space-y-24">
        <motion.div 
          ...
          className="space-y-6"
        >
          <h2 className="text-[10px] font-bold tracking-[0.8em] text-[#91766E]/60 uppercase">Product Ecosystem</h2>
          <h3 className="text-6xl md:text-8xl font-headline font-black tracking-tighter text-white">Things I've Built</h3>
          <p className="text-xl md:text-2xl text-[#B7A7A9] max-w-2xl font-light leading-relaxed">
          ...
          {PRODUCTS.map((product, idx) => (
            ...
            >
              <Link
                ...
                className={cn(
                  "group relative h-full w-full bg-[#B7A7A9]/[0.04] rounded-[3.5rem] p-12 border border-[#F6ECE3]/[0.05] flex flex-col justify-between overflow-hidden transition-all duration-700 hover:bg-[#91766E]/[0.08] hover:border-[#91766E]/30"
                )}
              >
                ...
                <div className="flex justify-between items-start relative z-10">
                  <motion.div 
                    ...
                    className="w-16 h-16 rounded-2xl bg-white/[0.03] border border-white/5 flex items-center justify-center group-hover:border-[#91766E]/40 group-hover:bg-[#91766E]/10 transition-all duration-500"
                  >
                    <product.icon className="w-8 h-8 text-[#B7A7A9] group-hover:text-[#F6ECE3]" />
                  </motion.div>
                  <div className="flex flex-col items-end gap-2">
                    <div className="px-4 py-1.5 rounded-full glass border-white/5 text-[8px] font-bold tracking-[0.3em] uppercase text-[#B7A7A9]">
                      {product.status}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 relative z-10">
                  <div className="space-y-1">
                    <p className="text-[9px] font-bold tracking-[0.5em] text-[#91766E] uppercase">{product.category}</p>
                    <p className="text-3xl md:text-5xl font-headline font-black text-white tracking-tighter leading-none group-hover:text-[#F6ECE3] transition-colors">
                      {product.title}
                    </p>
                  </div>
                  
                  <p className="text-[#B7A7A9] text-base leading-relaxed font-light opacity-0 group-hover:opacity-100 transition-all duration-700 translate-y-4 group-hover:translate-y-0">
                    {product.desc}
                  </p>
                </div>
                ...
                <div className="absolute bottom-12 right-12 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-x-4 group-hover:translate-x-0">
                  <div className="w-12 h-12 rounded-full glass flex items-center justify-center border-white/10 group-hover:bg-[#F6ECE3]/10">
                    <ExternalLink className="w-5 h-5 text-[#F6ECE3]" />
                  </div>
                </div>
              </Link>
            </motion.div>
