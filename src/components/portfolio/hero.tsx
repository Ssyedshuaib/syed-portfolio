        ...
        <div className="space-y-10 text-center lg:text-left">
          ...
          <div className="space-y-6">
            <div className="overflow-visible">
              <motion.h1 
                variants={lineVariants}
                className="text-4xl md:text-6xl lg:text-[clamp(2.2rem,5vw,4.8rem)] font-headline font-black tracking-tighter leading-[0.95] text-white uppercase drop-shadow-[0_10px_20px_rgba(0,0,0,0.5)]"
              >
