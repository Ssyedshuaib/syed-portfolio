  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-20 px-6 overflow-hidden bg-background">
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="visible"
        className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-20 lg:gap-32 items-center z-10"
      >
        <div className="space-y-12 text-center lg:text-left">
          ...
          <div className="space-y-8">
            ...
            <motion.p 
              variants={lineVariants}
              className="text-base md:text-xl text-[#EAE0C8]/40 max-w-lg mx-auto lg:mx-0 leading-relaxed font-light pt-4"
            >
